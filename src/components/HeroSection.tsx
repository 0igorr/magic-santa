      ...
      <div className="relative z-10 container mx-auto px-4 py-12 md:py-20 text-center">
        ...
        duration: 0.8
          ...
          delay: 0.4
            ...
            <Button variant="secondary" size="lg" className="text-sm md:text-base px-6 md:px-8 py-4 md:py-5 rounded-full font-medium flex items-center gap-2 backdrop-blur-sm bg-white/0 text-primary-foreground">
