    ...
    <section id="hero" className="relative h-[85vh] flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          ...
          src="/lovable-uploads/4f9cc7e5-9b01-47c1-8598-f6d1bdf372d9.webp" 
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 text-center">
        ...
        >
          ...
          >
            <Button 
              size="lg" 
              className="bg-primary hover:bg-primary/90 text-white text-base md:text-lg px-8 md:px-12 py-6 md:py-7 rounded-full shadow-button font-bold tracking-wide w-full max-w-md"
            >
              Criar vídeo
            </Button>
