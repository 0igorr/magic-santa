...
const videoProofs = [{
  id: 1,
  username: "@ania.skalska.firlej",
  thumbnail: "/lovable-uploads/4f9cc7e5-9b01-47c1-8598-f6d1bdf372d9.webp"
}, {
  id: 2,
  username: "@mostecjuszka",
  thumbnail: "/lovable-uploads/2139d4c4-0f1d-4d49-8f97-10254d5f96fc.webp"
}, {
  id: 3,
  username: "@ally_an_tcz",
  thumbnail: "/lovable-uploads/4f9cc7e5-9b01-47c1-8598-f6d1bdf372d9.webp"
}, {
  id: 4,
  username: "@aurelia_and_laura",
  thumbnail: "/lovable-uploads/2139d4c4-0f1d-4d49-8f97-10254d5f96fc.webp"
}, {
  id: 5,
  username: "@moze.kiedys",
  thumbnail: "/lovable-uploads/4f9cc7e5-9b01-47c1-8598-f6d1bdf372d9.webp"
}];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-7xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <div className="w-[200px] flex-shrink-0 -ml-[160px]">
                <div className="relative rounded-2xl overflow-hidden aspect-[9/16]">
                  <img src={videoProofs[visibleVideos.prev].thumbnail} alt={`Vídeo de ${videoProofs[visibleVideos.prev].username}`} className="w-full h-full object-cover" />
              ...
              <div className="relative w-[200px] flex-shrink-0">
                <div className="relative rounded-2xl overflow-hidden aspect-[9/16]">
                  <img src={videoProofs[visibleVideos.current].thumbnail} alt={`Vídeo de ${videoProofs[visibleVideos.current].username}`} className="w-full h-full object-cover" />
              ...
              <div className="w-[200px] flex-shrink-0 -mr-[160px]">
                <div className="relative rounded-2xl overflow-hidden aspect-[9/16]">
                  <img src={videoProofs[visibleVideos.next].thumbnail} alt={`Vídeo de ${videoProofs[visibleVideos.next].username}`} className="w-full h-full object-cover" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent pointer-events-none" />
                </div>
              </div>
            </div>
          ...
          <div className="hidden md:flex justify-center gap-3 lg:gap-4 px-16">
            {videoProofs.map(video => <div key={video.id} className="relative rounded-2xl overflow-hidden aspect-[9/16] w-[180px] lg:w-[200px] xl:w-[220px] group cursor-pointer flex-shrink-0">
                <img src={video.thumbnail} alt={`Vídeo de ${video.username}`} className="w-full h-full object-cover" />
