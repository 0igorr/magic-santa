...
const highlights = [
  { icon: Clock, stat: "5 min", label: "para criar" },
  { icon: Film, stat: "2h", label: "de entrega" },
  { icon: Sparkles, stat: "100%", label: "personalizado" },
  { icon: Heart, stat: "∞", label: "memórias" },
];

const VideoDemo = memo(() => {
  return (
    <section className="relative py-16 md:py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto">
          {/* Content */}
          <div className="text-secondary-foreground text-center animate-fade-in-up">
            {/* Eyebrow */}
            ...
            <p className="text-secondary-foreground/80 text-base md:text-lg mb-8 leading-relaxed">
              O Papai Noel chama pelo nome, mostra sua foto no livro mágico, dá conselhos e ainda
              deixa uma mensagem especial. Tudo em um vídeo cinematográfico feito só para sua
              criança. E 100% personalizado por você.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
              {highlights.map((item, index) => (
                <div
                  key={index}
                  className="text-center p-3 rounded-xl bg-secondary-foreground/5 backdrop-blur-sm animate-fade-in-up"
            ...
            <Link to="/formulario" className="inline-block">
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/90 text-primary-foreground text-base md:text-lg px-10 py-6 rounded-full font-bold shadow-xl hover:shadow-2xl transition-all shadow-button"
              >
                Criar vídeo agora
              </Button>
            </Link>
